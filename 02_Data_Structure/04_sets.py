...
# Creating sets
numbers = {1, 2, 3, 4, 5}
duplicates = {1, 2, 2, 3, 3, 4}  # duplicates are removed automatically
...
print("Union:", setA | setB)          # or setA.union(setB)
print("Intersection:", setA & setB)   # or setA.intersection(setB)
print("Difference:", setA - setB)     # or setA.difference(setB)
print("Symmetric Difference:", setA ^ setB)  # elements not common

# Membership
print("Is 2 in setA?", 2 in setA)
print("Is 10 not in setB?", 10 not in setB)
